...
2023/10/13
重写：
https://ikuuu.art/auth/login url script-request-body https://raw.githubusercontent.com/fsllala/qx/main/ikuuu.js
主机名：
ikuuu.art
*/
const $ = new Env("ikuuu");
...
async function checkin() {
  ...
  if (res.ret == 1) {
    const message = decodeURI(res.msg);
